...
const LoginWithOutPassword = ({navigation}) => {
    ...
    <View style={styles.container}>
        ...
        <View style={styles.header}>
            ...
            <View style={{width:'70%',height:"100%",justifyContent:"center",alignItems:'center'}}>
                <Text style={{color:"white", fontSize:18,fontWeight:'500'}}>Đăng nhập không cần mật khẩu</Text>
            </View>
        ...
        <View style={styles.body}>
            ...
            <View style={{paddingTop:30,paddingBottom:10,width:'100%',justifyContent:'center',alignItems:"center"}}>
                <TouchableOpacity style={{paddingTop:10,paddingBottom:10,paddingLeft:40,paddingRight:40,borderRadius:40,backgroundColor:themes.green}}>
                    <Text style={{color:'white',fontSize:16,fontWeight:'600'}}>Nhận liên kết</Text>
                </TouchableOpacity>
            </View>
        </View>
    </View>
